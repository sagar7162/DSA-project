...
function generateTreeFromInputs() {
    ...
    linkInputs.forEach(linkInput => {
        ...
        if (node1Index >= 0 && node1Index < nodesInTree.length &&
            node2Index >= 0 && node2Index < nodesInTree.length) {

            const node1Name = nodesInTree[node1Index];
            const node2Name = nodesInTree[node2Index];
