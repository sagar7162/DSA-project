...
function handleNodeRightClick(node, e) {
    ...
    // Display a custom menu (or use a prompt in this case)
    const action = prompt("Choose an action: Type 'edit' to edit or 'delete' to delete", "edit");
...
function createNode(x, y, value) {
    ...
    // Add right-click event listener for editing or deleting the node
    newNode.addEventListener("contextmenu", (e) => handleNodeRightClick(newNode, e));
